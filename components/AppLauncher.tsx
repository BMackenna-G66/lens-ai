...
type Suite = 'compliance' | 'criminal' | 'admin' | 'general-dashboard' | 'regcheq' | 'admin-docs';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-100 via-indigo-50 to-slate-100 dark:from-slate-900 dark:via-indigo-950 dark:to-slate-900 flex flex-col items-center justify-center p-6 transition-colors">
      ...
      <div className="relative w-full max-w-4xl">
        ...
        {/* Admin Doc Fetcher — Documentos de empresa desde Admin G66 */}
        <div className="mt-4">
          <button
            onClick={() => onSelect('admin-docs')}
          ...
          >
            ...
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1">
                <h2 className="text-xl font-black text-slate-900 dark:text-white mb-2">Documentos de Empresa</h2>
                <p className="text-slate-500 dark:text-slate-400 text-sm font-medium mb-4 leading-relaxed">
                  Busca una empresa por email o ID en Admin G66, visualiza todos sus documentos cargados con fecha y estado, selecciona los que necesites y descárgalos directamente.
                </p>
                <div className="flex flex-wrap gap-2">
                  {['📧 Búsqueda por Email', '🔢 Búsqueda por ID', '📅 Orden por Fecha', '☑️ Selección múltiple', '⬇️ Descarga directa'].map(tag => (
