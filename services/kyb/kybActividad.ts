...
const SINONIMOS: Record<string, string> = {
  ...
  // "E-commerce" contra "comercio por internet": el mismo giro escrito de dos
  // formas. Sin esto quedaba SIN RESPALDO y hundía el componente. Medido sobre
  // una empresa real de la cola.
  ECOMMERCE: 'VENTA', COMMERCE: 'VENTA', ECOMERCE: 'VENTA',
  MINORISTA: 'MENOR', MAYORISTA: 'MAYOR', RETAIL: 'MENOR',
  INTERNET: 'INTERNET', ONLINE: 'INTERNET', DIGITAL: 'INTERNET', WEB: 'INTERNET',
  TELEFONICA: 'TELEFONO', TELEFONICO: 'TELEFONO',
